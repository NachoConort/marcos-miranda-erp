  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<PrivateRoute><MainLayout /></PrivateRoute>}>
        ...
        <Route path="presupuestos/:id/editar"     element={<EditarPresupuestoPage />} />
        ...
        <Route path="representaciones/nueva"      element={<NuevaRepresentacionPage />} />
        <Route path="representaciones/:id/editar" element={<EditarRepresentacionPage />} />
      </Route>
