              ...
              <tbody>
                {data?.presupuestos?.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-gray-500 text-xs">
                      {p.comisionRepresentacion?.porcentaje}% ={" "}
                      {formatMoney(p.comisionRepresentacion?.monto)}
                    </td>
                    <td className="px-4 py-3 text-gray-500 text-xs">
                      {p.comisionVendedor?.porcentaje}% ={" "}
                      {formatMoney(p.comisionVendedor?.monto)}
                    </td>
                      ...
                      <div className="flex items-center gap-1.5">
                        {p.estado !== "convertido" && (
                          <>
                            ...
                            <button
                              onClick={() =>
                                navigate(`/pedidos/nuevo?presupuesto=${p._id}`)
                              }
                            ...
                            <button
                              onClick={() => {
                                if (
                                  confirm(`¿Eliminar presupuesto #${p.numero}?`)
                                )
                                  eliminar(p._id);
                              }}
